...
\noindent Truth entailment can be found in \textit{potwierdzić} and is absent in \textit{potwierdzać}; whereas it seems to follow from \REF{21:3} that Marek fears ghosts, \REF{21:4} states that this is a possible, but not an obligatory interpretation. The inference presented in \REF{21:3} does not project, which excludes it from being a presupposition. Consider \REF{21:5}.
