...
In this paper we look at the sluicing examples with particles more closely in order to better understand where exactly particles are located and where they originate. We \isi{present} new arguments against placing particles inside wh-phrases and show that particles really are part of the \isi{left periphery} and thus offer further support for the analysis according to which non-wh-material in the \isi{left periphery} does not have to be elided in sluicing in \ili{Slovenian} \citep{marusicetal2015}.
