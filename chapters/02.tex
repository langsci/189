...
\noindent This means that \isi{stative} subevents are not represented in the syntax of ditransitives with \isi{dative} arguments. If they were \isi{present} in the syntactic representation, they could be singled out at least in cases when datives are scrambled.
