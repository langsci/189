...
\maketitle
\shorttitlerunninghead{The \ili{Russian} \isi{perfective} present in \isi{performative} utterances}
...
\ea\label{ex:sechs}
\gll \ili{Blagodarju} 		za ponimanie.\\
...
\textsc{ipv}&\isi{imperfective aspect}\\
...
\textsc{ptcl}&particle\\
\textsc{pv}&\isi{perfective aspect}\\
\textsc{RNC}&\ili{Russian} National Corpus\\
\textsc{sg}&singular\\
\end{tabularx}
