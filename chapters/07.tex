...
\noindent Standard grammars of both \ili{Croatian} and \ili{Serbian} often focus on essentially eliminating the variation and prescribing one option as ``more natural'' for a given variety. Therefore, in a sense, they \isi{present} an overly rigid either--or, binary picture of variation in these domains.
