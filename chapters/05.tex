...
\ea {Russian stressed vowels}\label{5:1}\\\medskip
...
\ea {Vowel reduction after hard consonants (Standard Russian)}\label{5:4}\\\medskip
...
Russian vowel reduction after a soft consonant is illustrated in \REF{5:5}. Substantially, /a/, /o/ and /e/ are fronted and raised to [i] in first pretonic \REF{5:5a}, in other pretonic syllables \REF{5:5b}, and in post-tonic syllables \REF{5:5c}.
...
\ea {Reduced vowels after soft consonants (Standard Russian)}\label{5:6}\\\medskip
\begin{tabular}{|p{1.7cm}p{1.7cm}|}
\hline
...
\ea {Reduced vowels after \textit{š, ž, ts} (Standard Russian)}\label{5:8}
\begin{multicols}{2}
...
Substantially, /a/ and /o/ are centralized to [ə] after soft consonants \REF{5:9a} and \textit{š}, \textit{ž} or \textit{ts} \REF{5:9b}. As for /e/, it is raised to [i] after a soft consonant \REF{5:9c}, and [ɨ] after \textit{š}, \textit{ž} or \textit{ts} \REF{5:9d}.
...
\ea {Russian unstressed vowels}\label{5:17}\\\medskip
\begin{tabular}{|P{1.7cm}|P{1.7cm}|}
\hline
/I/&/U/\\\hline
\multicolumn{2}{|c|}{/A/}\\\hline
...
\ea {Representation of Russian vowels (preliminary version)}\label{5:19}\\\medskip
\begin{tabular}{|P{1.7cm}|P{1.7cm}|}
\hline
...
\ea {Representation of Russian vowels (final version)}\vspace{-8pt}\label{5:20}\begin{multicols}{2}
...
\ea {Principles of Russian vowel reduction (first attempt)}\label{5:21}
