...
\begin{document}
\maketitle
\shorttitlerunninghead{A thought on the form and the substance of \ili{Russian} vowel reduction}
...
\ea \textsc{\ili{Akanye}:} neutralization of /a/ and /o/
...
\begin{figure}
\subfigure[After a hard \isi{consonant}\label{5:f1a}]{
\includegraphics[height=0.3\textheight]{figures/05enguehard_f1.eps}
}
\subfigure[After a \isi{soft consonant}\label{5:f1b}]{
...
Dialects with proper Okanye have no \isi{vowel reduction} (some subtypes can show some neutralizations in specific segmental contexts; see \citealt[§46, §56]{Avanesov1949}). \ili{Akanye} and Ikanye refer to the reduction patterns illustrated in \REF{5:4} and \REF{5:6} respectively. In what follows, I address the remaining Ukanye and Yakanye patterns.
