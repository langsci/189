...
The \isi{present} paper contributes to the discussion of microvariation within the realm of \ili{Slavic} aspect. 
...
For the \isi{present} purposes, therefore, the move from \citet{Dickey2000} to \citet{Dickey15} is by and large irrelevant. 
...
The aim of the \isi{present} study is twofold. The first goal is to describe the kinds of contexts in which the western language \ili{Czech} displays general-factual perfectives, whereas 
