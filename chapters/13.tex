...
\midrule     &  $\quad\quad\quad\quad$ \ili{Polish} & $\,$\ili{Russian} \\
   Sorbian  &    & $\,$Belarusian \\
    \ili{Czech}  &    &  $\,$\ili{Ukrainian}\\ 
  $\,$  \ili{Slovak}  &    &  \\
   $\,\,\,\,\,$  \ili{Slovene}  &    & \ili{Bulgarian} \\
...
\midrule  \textsc{west}$\quad\quad\quad\quad$ & \multicolumn{2}{l}{\textsc{transitional}} & \textsc{east}\vspace{-0.0cm}\\
 \midrule  \ili{Czech}  &   \multicolumn{2}{l}{$\quad\,\,$Polish} & \ili{Russian} \\
  \ili{Slovak}   &   \multicolumn{2}{l}{} &  \ili{Ukrainian} \\
    Sorbian  &   \multicolumn{2}{l}{} & Belarusian \\
     \ili{Slovene} &   \multicolumn{2}{l}{} & \\
...
use \isi{perfective} forms to denote completed past events only vaguely located in time? 
