...
In \sectref{13:s2} I will introduce the phenomenon of perfective general-factuals in Czech and Polish. 
...
In \sectref{13:s5} I will discuss and reject the hypothesis (brought up by myself) that perfective general-factuals are explicable in terms of event uniqueness.
...
In \sectref{13:s8} the situation in Russian will be taken into account. I will explain why general-factual contexts are per se incompatible
...
The Russian sentence that she uses to express that is \REF{13:dereva}:\footnote{I reduce grammatical information in the gloss to a relevant minimum. \textsc{ipf} is for imperfective, \textsc{pf} is for perfective aspect. Other abbreviations are explained at the end of the paper.}
...
\noindent This is a canonic instance of a Russian general-factual imperfective. A similar one is sentence \REF{13:shifer}, which the young lady uses to convey fact 7:
...
\noindent The following pair of examples contrasting Polish general-factual perfectives \REF{13:portfel} and Russian general-factual imperfectives \REF{13:koselek} is taken from \citet{Wiemer01}:
...
Czech and Polish resort to imperfective aspect, just like Russian does. The examples \REF{13:korovu} to \REF{13:krowe} may serve as illustration.   
...
\noindent As can be seen and as expected, Russian speakers use imperfective aspect here. Now, as can be seen in \REF{13:lake} and \REF{13:lakepo}, speakers of Czech and speakers of 
...
Accordingly, the reason why \REF{13:lake} and \REF{13:lakepo} have perfective predicates should be that these predicates are formed from 
...
they may be used in that function, quietly and without fuss. Consider the Polish example in \REF{13:jezioro}:
...
\noindent Example \REF{13:jezioro} proves that the Polish predicate meaning `freeze over' characterizes 
...
of taking on imperfective morphology. But then, why does it not show up in the imperfective in \REF{13:lakepo}?
...
Fair enough, but consider the Czech equivalent to \REF{13:jezioro}:
...
the sentences \REF{13:lake} and \REF{13:lakepo} denote achievements \textit{because} they are perfective. 
...
on the course of events. Also sentences like \REF{13:lake} may be accounted for, as the event participant is inanimate and, hence,
void of volition.
...
as the hypothesis H2 suggests, examples like Czech \REF{13:prkna} and Polish \REF{13:trampolin} should not exist.  
...
aspect in favour of the perfective. Contra to that prediction, however, the imperfective appears to be well suited to figure in the Czech example \REF{13:blinddarm}.
...
\noindent Here, too, it is possible to use an imperfective verb form under reference to a completed event, which is in conflict with H3/H3'.\footnote{According to the reviewer, the use of the perfective form leads to an interpretation involving target state relevance (see \sectref{13:s8}). It needs to be checked whether target state relevance is indeed obligatory when the perfective is used in \REF{13:blinddarmpo}. If yes: Does it follow from the semantics of the perfective? Then Polish would approximate the Russian pattern. Or does it rather follow from pragmatic inferences, presumably in competition with the imperfective? I must leave this issue open.}
...
\noindent What \REF{13:semas} basically says is that the use of a perfective form will always impose on interpretation the conditions of completedness
...
Context 1: The choice of the perfective expressing uniqueness is felicitous because the speaker wants to refer to an accident. This is the case in \REF{13:stromu}, repeated here for convenience.  
...
Given this, communicating the existence of an accident, as in \REF{13:baumrep}, or requesting the existence of an accidental event, as in \REF{13:portfel} from above, will always invite an inference of uniqueness. It follows from hypothesis H4 that the perfective is to be used because otherwise the event would be understood as non-unique and, hence, as non-accidental.

Context 2: The choice of the perfective is felicitous because the speaker refers to an action that requires unusual skills. \REF{13:prknarep}, for instance, refers to a dare. It should be read here as an answer to \REF{13:prkna}:
...
Similar to the case of accidents, it then follows that if the speaker states that she has performed the action once, she may be sure not to be expected to having performed it a second time. Thus, the expression of uniqueness, which H4 attributes to the use of perfective aspect, is well grounded in the context of \REF{13:prknarep}.
...
\noindent Context 3: The choice of perfective aspect is felicitous because the speaker refers to an extraordinary event, see \REF{13:lakerep}. 
...
Crucially, our new hypothesis H4 does \textit{not} dictate perfectivity for \REF{13:blinddarm3}. Since H4 incorporates the assumption that the aspectual operators PF and IPF take VP-meanings as input, and since the VP of
\REF{13:blinddarm3} does not involve uniqueness, the use of imperfective aspect is not ruled out on
...
\noindent Speakers of Czech may refuse an invitation to supper by uttering \REF{13:abendessen}. The utterance will be felt 
...
In sum, the VP does not determine the uniqueness of the event in \REF{13:abendessen}, the use of the perfective is therefore not mandatory, and imperfective aspect remains an option according to hypothesis H4. 
...
\noindent The ``semantically unmarked'' imperfective will be the same in all of the discussed languages:\footnote{\label{13:fnm}I wish to point out that under the proposed analysis (which closely follows \citealt{Gronn2004}) the imperfective is, in fact, not unmarked/unspecified, but rather radically \textit{under}specified in comparison to the perfective. Thus, the approach is \textit{not} Jakobsonian. The meanings in \REF{13:czru2} and \REF{13:czru3} all represent Hauptbedeutungen in the sense of \citet[178]{Kury60}.}
...
\noindent In \REF{13:czru2}, target state validity is implemented in the Russian perfective operator as an additional condition besides completedness and uniqueness.
...
\citet[112]{Dickey2000} reports that the Polish perfective in \REF{13:win} is possible given the following scenario: 
