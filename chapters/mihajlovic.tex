...
\lspbottomrule
\end{tabularx}
\caption{\label{tab:mihajlovic:1} Sibilants of standard varieties of Bosnian/Croatian/Serbian (phonetic symbols with Latin orthography in slanted brackets)}\todo[inline]{slashes instead of ``slanted brackets''?}
\todo[inline]{Check table layout against original}
\end{table}
...
\sectref{sec:mihajlovic:2} situates our study in the broader context of heritage language research. 
...
\subsection{Methodology}\todo{orphaned subsection}
...
Tokens were presented using headphones connected to a computer. Participants were tasked with indicating what they hear by clicking either the left arrow for /ć/, /č/ or /š/, or the right arrow for /đ/, /dž/ or /c/, as shown in \figref{fig:mihajlovic:4}.
...
The following sections present the findings. \sectref{sec:mihajlovic:5.1} presents the basic descriptive statistics, \sectref{sec:mihajlovic:5.2} compares the results for Generation 1 and Generation 2 speakers. In \sectref{sec:mihajlovic:5.3}, the results of the current study are compared with the available results of homeland speakers in Ćavar and \citet{Hamann2011}. \sectref{sec:mihajlovic:5.3} addresses the length of stay in the U.S. as a potential factor influencing the merger in the first generation of immigrants and \sectref{sec:mihajlovic:5.5} looks at the potential differences in the perception of different categories.
...
\figref{fig:mihajlovic:6} shows the perception accuracy by sound type for voiceless sounds.
...
Contrary to what was expected, post-alveolar affricates and alveolo-palatal affricates reached similar level of accuracy in the identification task, however, the difference in the identification of the two merging categories was not significant, neither for Generation 1 nor Generation 2. /š/ is correctly identified more often than both alveolo-palatal /ć/ and post-alveolar /č/, for both generations and the difference is statistically relevant, cf. \tabref{tab:mihajlovic:7}.
...
\todo[inline]{maybe use "123 [234--456]" instead of OR and CI}
\todo[inline]{unify length of decimals}
\end{table}
